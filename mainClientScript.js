...
import { socket, setPassant, vars, changeVar, getID } from "./data.js";
...
import { doMove } from "./moves.js";

const CHAR_RETURN = 13;
const inputAnotherPlayersIDHere = document.getElementById(
  "inputAnotherPlayersIDHere",
);
let connectedToID;
...
const move = (parsed) => {
  ...
  if (parsed.clear) clear();
    ...
    if (end) {
      endTheGame(
        "repeatingTheSameMoves",
        "You have a draw. Reason: repeating the same moves",
      );
    }
  }
