...
const moveTo = (Piece, rowMoveTo, columnMoveTo) => {
...
const movesExist = {
    ...
    Bishop: (piece, column, row) => {
        if (column > 0 && row > 0){
            if (moveTo(piece, row - 1, column - 1)){
                return 'makeMove exist';
            }
        }
        if (column < 7 && row > 0) {
    ...
    Knight: (piece, column, row) => {
        if (column > 0) {
            if (row > 1)
                if (moveTo(piece, row - 2, column - 1)) return 'makeMove exist';
            if (row < 6)
                if (moveTo(piece, row + 2, column - 1)) return 'makeMove exist';
            if (column > 1) {
                if (row > 0)
                    if (moveTo(piece, row - 1, column - 2))
                        return 'makeMove exist';
                if (row < 7)
                    if (moveTo(piece, row + 1, column - 2))
                        return 'makeMove exist';
